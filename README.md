...
Self-signed origin TLS is generated by `/usr/local/bin/kanidm-cert-helper`, a small static Go helper built into the image. The final Kanidm image does not include an OpenSSL runtime or copied OpenSSL dynamic libraries.
